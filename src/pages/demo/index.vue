...
<template>
  <view class="bg-#e2f3fe p-4">
    ...
    <view class="p-5 bg-white rounded-xl shadow-md flex items-center mx-auto">
      <view>
        <view
          class="h-100 w-100 bg-cover bg-[url(https://fastly.jsdelivr.net/gh/MellowCo/image-host/2022/202211222039023.png)]"
        />
      </view>
      <view class="ml-5">
    ...
    <view rounded-xl shadow-md flex items-center mx-auto p-5 bg-white>
      <view>
        <view
          h-100
          w-100
          bg="cover [url(https://fastly.jsdelivr.net/gh/MellowCo/image-host/2022/202211222039023.png)]"
        />
      </view>
      <view ml-5>
        <view text="xl c1">
    ...
    <view flex justify-center items-center my-2>
      <view
        ...
        bg-cover
        class="bg-[url(https://fastly.jsdelivr.net/gh/MellowCo/image-host/2022/202211222039023.png)]"
      />
